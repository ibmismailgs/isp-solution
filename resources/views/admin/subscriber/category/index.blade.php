<x-app-layout>
    ...
    @endpush
    @section('title', 'Subscriber Categories')
    ...
    <x-slot name="header">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('admin.subscriber-category.create') }}" type="button" class="btn btn-sm btn-info">
    ...
    <script>
        ...
        var dTable = $('#example').DataTable({
            ...
            ajax: {
                url: "{{route('admin.subscriber-category-list')}}",
                type: "post"
            },
    ...
    $('.card').on('click', '.changeStatus', function (e) {
        ...
        if (confirm('are you sure, want to change this status?')) {
            $.ajax({
                'url':"{{ route('admin.subscriber-category-status') }}",
                'type':'post',
                'dataType':'text',
