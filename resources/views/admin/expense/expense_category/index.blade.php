<x-app-layout>
    ...
    <x-slot name="header">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('admin.expense-category.create') }}" type="button" class="btn btn-sm btn-info">
    ...
    <script>
        ...
        var dTable = $('#example').DataTable({
            ...
            ajax: {
                url: "{{route('admin.expense-categories')}}",
                type: "post"
            },
    ...
    // end delete function
        ...
        $('.card').on('click', '.changeStatus', function (e) {
            ...
            $.ajax({
                'url':"{{ route('admin.expense-category-status') }}",
                'type':'post',
                'dataType':'text',
                ...
                success:function(data)
                {
                    ...
                    if(data == "success"){
                        toastr.success('Status is Active', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }else{
                        toastr.error('Status is Inactive ', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
                }
            });
