                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option value="{{ $identity->status }}" selected="">
                                                @if ($identity->status == 1) Active
                                                @else Inactive
                                                @endif</option>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="2" rows="2" class="form-control" placeholder="Describe here...">{{ $identity->description }}</textarea>
                                    </div>
                                </div>
