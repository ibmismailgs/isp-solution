    ...
    <x-slot name="header">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <h4>List of ID Card Types</h4>
                </div>
            </div>
            <div class="page-title-actions">
                <a href="{{ route('admin.identity.create') }}" type="button" class="btn btn-sm btn-info">
