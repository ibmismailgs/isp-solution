<x-app-layout>
    ...
    <x-slot name="header">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                @can('bank_create')
                <a title="Create Button" href="{{ route('admin.service-setting.create') }}" type="button" class="btn btn-sm btn-info">
    ...
    <script>
        ...
        var dTable = $('#example').DataTable({
            ...
            ajax: {
                url: "{{route('admin.service-setting-list')}}",
                type: "post"
            },
            columns: [
                {
    ...
    $('.card').on('click', '.changeStatus', function (e) {
        ...
        var id = $(this).attr('getId');
          ...
          if (changeStatus) {
            $.ajax({
                'url':"{{ route('admin.service-setting-status') }}",
                'type':'post',
                'dataType':'text',
                'data':{id:id},
