    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" action="{{ route('admin.service-setting.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ $data->title }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter title" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="icon" id="icon" data-height="96" data-default-file="{{ asset('img/' . $data->icon) }}" class="dropify form-control @error('icon') is-invalid @enderror" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        rows="4" id="description" class="form-control @error('description') is-invalid @enderror" placeholder="Describe here...">{{ old('description', $data->description) }}</textarea>
                                        @error('description')
                                        <span class="text-danger" role="alert">
                                            <p>{{ $message }}</p>
                                        </span>
