    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                         <form enctype="multipart/form-data" action="{{ route('admin.about-setting-store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="image">About Image<span class="text-red">*</span></label>
                                        <input type="file" name="image" id="image" data-height="145" @if ($data) data-default-file="{{ asset('img/' . $data->image) }}" @endif class="dropify form-control @error('image') is-invalid @enderror" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control @error('answer') is-invalid @enderror" rows="6" placeholder="Write description here.." required>{{ isset($data) ? $data->description : old('description') }}</textarea>
